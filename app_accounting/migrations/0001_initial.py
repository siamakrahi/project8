    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon_class', models.CharField(default='flaticon-profit', max_length=50, verbose_name='کلاس آیکون (flaticon)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('two_factor_method', models.CharField(choices=[('sms', 'ارسال کد via SMS'), ('totp', 'برنامه احراز هویت (Google Authenticator)'), ('none', 'غیرفعال')], default='none', max_length=10)),
